...
#ifndef XCAPTCHA_BASE_H
#define XCAPTCHA_BASE_H
#include <string>
#include <utility>
#include <vector>
#include <map>
...
class basic_config {
 ...
 public:
  ...
  using reverse_iterator = json_reverse_iterator<typename basic_config::iterator>;
  using const_reverse_iterator = json_reverse_iterator<typename basic_config::const_iterator>;
 ...
 public:
  ...
  template<typename CompatibleType, typename U = utils::uncvref_t<CompatibleType>,
      utils::enable_if_t<not std::is_base_of<std::istream, U>::value and
          not std::is_same<U, basic_config_t>::value and
  ...
  template<class InputIT, typename std::enable_if<
      std::is_same<InputIT, typename basic_config_t::iterator>::value or
          std::is_same<InputIT, typename basic_config_t::const_iterator>::value, int>::type = 0>
 ...
 public:
  ...
  template<
      ...
      utils::enable_if_t<
          not std::is_same<basic_config_t, ValueType>::value and
              utils::has_from_json<basic_config_t, ValueType>::value and
  ...
  template<
      typename ValueTypeCV,
      typename ValueType = utils::uncvref_t<ValueTypeCV>,
      utils::enable_if_t<not std::is_same<basic_config_t, ValueType>::value and
  ...
  template<class ValueType, typename std::enable_if<
      std::is_convertible<basic_config_t, ValueType>::value, int>::type = 0>
  ...
  template<class IteratorType, typename std::enable_if<
      std::is_same<IteratorType, typename basic_config_t::iterator>::value or
          std::is_same<IteratorType, typename basic_config_t::const_iterator>::value, int>::type
  = 0>
