    ...
    namespace detail {
        ...
        public:
            ...
            bool operator==(const iter_impl &other) const {
                ...
                switch (m_object->m_type) {
                    case value_t::map:
                        return (m_it.map_iterator == other.m_it.map_iterator);
            ...
            bool operator<(const iter_impl &other) const {
                ...
                switch (m_object->m_type) {
                    case value_t::map:
                        CONFIG_THROW(invalid_iterator::create(213, "cannot compare order of map iterators"));
            ...
            iter_impl &operator+=(difference_type i) {
                ...
                switch (m_object->m_type) {
                    case value_t::map:
                        std::advance(m_it.map_iterator, i);
                        break;
